...
class Futil():
    ...
    def gen_LL(Lz,num_lls=4):
        """
            ...
            num_lls set to 1 means only lowet Landau level
            return a list of len num_lls
                in which each element is a list of len Lz
                in which each element is a numpy array of len Npts**2
        """
        ...
        for m in range(Lz):
            e=(r**m)*numpy.exp(-rsq/4) # lb has been divided in def of r
...
def plot2():
    ...
    num_lls=4
    lls=Futil.gen_LL(30,num_lls=num_lls)
